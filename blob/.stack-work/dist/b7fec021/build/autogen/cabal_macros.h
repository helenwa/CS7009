...
/* package blob-0.1.0.0 */
#define VERSION_blob "0.1.0.0"
#define MIN_VERSION_blob(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "blob-0.1.0.0-DBS5aE820NDDkXCEL3CFzC"

#define CURRENT_PACKAGE_KEY "blob-0.1.0.0-DBS5aE820NDDkXCEL3CFzC"
